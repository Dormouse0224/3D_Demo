...
CWeightMapCS::CWeightMapCS()
	: CComputeShader(L"HLSL\\Engine\\weightmap.fx", "CS_WeightMap", 32, 32, 1)
	, m_WeightMap(nullptr)
...
{
	m_BrushTex->Unbind_CS();
	m_WeightMap->Unbind_CS_UAV();
	m_RaycastOut->Unbind_CS();
}

void CWeightMapCS::UIRender()
{
}

void CWeightMapCS::SetDataInfo()
{
}
